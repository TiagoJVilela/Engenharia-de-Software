...
var max_notes = 10; // maximum number of notes one can store
...
html5sticky.addNote = function(){
    ...
    if (tnotes === max_notes){
       html5sticky.showMessage('#FFE16B', 'black', 'Não podes criar mais notas, elimina alguma');
       return false;
    }
...
html5sticky.saveNote = function(el){
   if (Modernizr.localstorage){
      ...
      html5sticky.showMessage('#9BED87', 'black', 'Nota guardada :)');
